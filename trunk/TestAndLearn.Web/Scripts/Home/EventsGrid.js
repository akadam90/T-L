...
TestAndLearn.Home.EventsGrid = (function () {
    ...
    var sharedColNames = ['EventId','ClientId','Name','Description','StartDate','EndDate',''];
    var sharedColModel = [
        {
            name:'EventId',
            index:'EventId',
        ...
        },
        {
            ...
            fixed: true,
            formatter: function (cellvalue, options, obj) {
                return '<a href="javascript:void(0)" class="delete-link delete-event" id="delete-event-row-' + obj.EventId + '" ></a>';
            ...
            $('#event-grid').jqGrid(
            {
                ...
                loadComplete: function (data) {
                    ...
                    $('#event-grid .delete-event').click(function(e){
                        ...
                        TestAndLearn.Home.DeleteEventForm.deleteEvent(id);
