...
using TestAndLearn.Domain.Infrastructure.Repositories;
...
namespace TestAndLearn.Web
{
    public class CastleWindsorConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            container.Register(Component.For<IEventRepository>().ImplementedBy(typeof(EventRepository)));
            container.Register(Component.For<ICalendarRepository>().ImplementedBy(typeof(CalendarRepository)));
