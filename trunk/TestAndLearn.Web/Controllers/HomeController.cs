...
namespace TestAndLearn.Web.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public ActionResult TestForm(int id)
        {
            ...
            var user = _userRepository.GetUser(this.User.Identity.Name);
            var pillars = _testRepository.GetPillars(id);
        ...
        public ActionResult DownloadTests(FilterTestModel filterModel)
        {
            ...
            using (ExcelEngine excelEngine = new ExcelEngine())
            {
                ...
                sheet[row, ++col].Text = "Success Metric";
                sheet[row, ++col].Text = "Pillar";
                ...
                foreach (var test in tests)
                {
                    ...
                    sheet[row, ++col].Value = test.TestTypesAsString;
                    sheet[row, ++col].Value = test.SuccessMetric != null ? test.SuccessMetric.Name : "";
                    sheet[row, ++col].Value = test.Pillar != null ? test.Pillar.Name : "";
