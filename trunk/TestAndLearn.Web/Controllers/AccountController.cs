...
namespace TestAndLearn.Web.Controllers
{
    public class AccountController : BaseController
    {
        ...
        {
            this.Response.AddHeader("AuthenticationRequired", "1");
        ...
        public ActionResult Login(LogOnModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("ValidationError", "The user name or password provided is incorrect.");
                }
            }
        ...
        {
            this.Response.AddHeader("Unauthorized", "1");
            this.Response.AddHeader("AuthenticationRequired", "1");
            return View();
        }
